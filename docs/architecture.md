...
- **Executors**: Adapters to run tasks via manual, mini-SWE-agent, OpenHands, native-preview, external coding CLI execution (`codex`, `gemini`, `claude`, `opencode`, `antigravity`, `warp` plus aliases), and configured bring-your-own CLI agents.
