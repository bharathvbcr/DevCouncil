...
For a source checkout, prefix the command with `uv run --frozen` while running
from the DevCouncil repository root. The target repository must already exist.
...
- Ruff and mypy passed for the changed Python implementation; diff whitespace
  checks passed. Ten native/installed skill files passed the skill validator.
...
```bash
uv run --frozen pytest tests/unit/test_devmap_skill_delivery.py tests/unit/test_skills.py tests/unit/test_skills_bounding.py tests/unit/test_cli_skills.py tests/unit/test_skills_command.py tests/unit/test_skill_ranking_and_secrets.py tests/unit/test_okf_skills_export.py tests/unit/test_claude_assets.py tests/unit/test_plugin_manifest_metadata.py -q
uv run --frozen pytest tests/unit/test_integrate_clients.py tests/unit/test_integrate_commands_cli.py tests/unit/test_integrate_config_batching.py tests/unit/test_integrations_actions.py tests/unit/test_setup_unit.py tests/unit/test_cli_boot.py tests/unit/test_skills_from_okf.py tests/unit/test_skill_okf_bridge.py -q
uv run --frozen ruff check src/devcouncil/skills/registry.py src/devcouncil/cli/commands/skills.py tests/unit/test_devmap_skill_delivery.py tests/unit/test_skills.py
uv run --frozen mypy src/devcouncil/skills/registry.py src/devcouncil/cli/commands/skills.py
```
