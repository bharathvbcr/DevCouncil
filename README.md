...
- **Dashboard:** `dev dashboard --open` serves a local status dashboard (including a blocking-first **gaps** table) and opens it in the default browser for project state and live workflow visibility.
