...
def render_evidence_workflow(
    ...
    *,
    ...
    steps += [
        ...
        "      - name: Write release-health report",
        f"        run: {dev_command} report release-health --json --output .devcouncil/release_health.json --fail-on-regression --project-root .",
        ...
        "            .devcouncil/release_health.json",
