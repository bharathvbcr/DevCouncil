...
//! and `.github/workflows/rust.yml` builds and tests that shape per crate.
//!
...
/// CI job in `.github/workflows/rust.yml` is what proves it.
...
fn workspace_root() -> PathBuf {
    // `CARGO_MANIFEST_DIR` is `<workspace>/devmap-cli`.
