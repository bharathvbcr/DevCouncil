...
//! Live example on this workspace at the time of writing: `rust/.gitignore`
//! carries `/target/`, which does not match `rust/target-laneA`, and
//! `git ls-files --others --exclude-standard` listed 58,428 paths under
//! `rust/target-lane*` — all of them tagged, none of them indexed.
//!
