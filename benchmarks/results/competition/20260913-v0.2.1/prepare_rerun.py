"""Prepare fresh corpus clones with the previous protocol and verified local tools."""
import datetime
import hashlib
import json
import os
...
def main():
    ...
    plan.update(status='prepared', scratch=str(SCRATCH), devmap_binary=str(binary),
                comparison_baseline='../20260912-expanded', devmap_version='0.2.1',
    ...
    env['GORTEX_DAEMON_SOCKET'] = '/tmp/dmbench021-20260913.sock'
