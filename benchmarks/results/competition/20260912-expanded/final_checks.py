...
# Preserve the failing metadata before testing the documented forced rebuild.
...
assert json.loads((OUT/'gitnexus-repeat-stale-query.stdout').read_text())['symbol']['name']=='devmap_competition_revision_3'
assert json.loads((OUT/'gitnexus-after-force-query.stdout').read_text())['error']=="Symbol 'devmap_competition_revision_3' not found"
