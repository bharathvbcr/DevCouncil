...
reproducibility limits, and suggested next experiments. It reruns the
[previous report](results/competition/20260913-v0.2.1/REPORT.md) because the
installed DevMap executable advanced 49 commits past the build that report
measured. The [DevMap guide](../docs/devmap/README.md#benchmark-comparison) has
the shorter summary; the [competition index](results/competition/README.md) also
