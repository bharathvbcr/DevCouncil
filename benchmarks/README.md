...
The mapping engine's required gates are measured by `verify.sh`; the kernel's
own `--json` timings explain its phases. Where `run_bench.py` asks whether the gated
